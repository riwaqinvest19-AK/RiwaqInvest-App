-- Enforce 10,000 DZD minimum investment app-wide.

alter table public.projects
  alter column min_investment set default 10000;

update public.projects
set min_investment = 10000
where min_investment is null or min_investment <> 10000;
...
begin
  ...
  if p_amount < v_min_investment then
    raise exception 'Minimum investment is % DZD', v_min_investment;
  end if;
